namespace ReportingFixedDocument
{
    ...
    /// <summary>
    /// Interaktionslogik für FixedDocuments.xaml
    /// </summary>
    public partial class A4QuerFixedDokument : Window
    {
        private FixedDocument _fixedDocument;
        private Size paperSize = ReportPaperSize.A4Landscape();

        public A4QuerFixedDokument()
        {
        ...
        private static FixedPage CreatePage(FixedDocument document, List<MyItem> source)
        {
            ...
            resultPage.Line(TOP, LEFT, resultPage.Width, 2);
